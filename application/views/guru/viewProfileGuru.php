 ...
 <!-- Navigation -->
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            ...
            <ul class="nav navbar-top-links navbar-right">
                <li class="dropdown">
                    <a class="sidebar-nav navbar-collapse" href="<?php echo base_url('/index.php/guru/c_guru/logout')?>">Logout</a>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
                <!-- /.dropdown -->
                        ...
                        <table cellpadding="0" cellspacing="0" border="1" class="datatable-1 table table-bordered table-striped  display" width="100%">
                                        ...
                                        <?php 
                                            ...
                                            { 
                                                ?>
                                            <tr>
                                                <th>NIP     : <?php echo $u->nip ?></th>
                                            </tr>
                                            <tr>
                                                <th>Nama Guru   : <?php echo $u->nama_guru ?></th>
                                            </tr>
                                            <tr>
                                                <th>Alamat  : <?php echo $u->alamat_guru ?></th>
                                            </tr>
                                            <tr>
                                                <th>Nomor Guru  : <?php echo $u->nomor_guru ?></th>
                                            </tr>
                                        </thead>
